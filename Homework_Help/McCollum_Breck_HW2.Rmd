...
So here you needed to download the hw\_gapminder.csv file and I'd recomment putting it in your current working directory (probably your homework directory, or your hw help directory). Then you use read.csv('PathToFileHere') to read it in. If you run the code above and the hw_gapminder.csv document is in the same folder as this document that should just work.  

Try at least one or two of these for now. If it's taking more than 10 minutes at this point, abort.